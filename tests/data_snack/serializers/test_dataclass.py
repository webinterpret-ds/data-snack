...
def test_serialize(serializer: DataclassSerializer, example_entity: Car, example_entity_hash: bytes) -> None:
...
def test_serialize_multi(
        serializer: DataclassSerializer, example_entities: List[Car], example_entities_hashes: List[bytes]
) -> None:
...
def test_deserialize(serializer: DataclassSerializer, example_entity: Car, example_entity_hash: bytes) -> None:
