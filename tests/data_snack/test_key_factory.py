...
def test_key_factory(entity_name: Text, key_values: List[Text], expected_key: Text) -> None:
...
def test_key_factory_cluster(entity_name: Text, key_values: List[Text], expected_key: Text) -> None:
